...
CHAPTERS = {
    ...
    "Physical Optics": "Interference, diffraction, polarization, Huygens' principle, optical instruments",
    "Special Relativity": "Postulates of relativity, time dilation, length contraction, mass-energy equivalence, relativistic momentum",
}
